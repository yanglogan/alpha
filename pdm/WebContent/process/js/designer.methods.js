...
Designer.addFunction("setLineStyle", function(e) {
	...
	for(var b = 0; b < d.length; b++) {
		...
		if( typeof e.lineWidth != "undefined") {
			a.lineStyle.lineWidth = e.lineWidth
		}
		if( typeof e.lineColor != "undefined") {
			a.lineStyle.lineColor = e.lineColor
		}
		if( typeof e.lineStyle != "undefined") {
			a.lineStyle.lineStyle = e.lineStyle
		}
		if(a.name == "linker") {
			if( typeof e.beginArrowStyle != "undefined") {
				a.lineStyle.beginArrowStyle = e.beginArrowStyle;
				Schema.linkerDefaults.lineStyle.beginArrowStyle = e.beginArrowStyle
			}
			if( typeof e.endArrowStyle != "undefined") {
				a.lineStyle.endArrowStyle = e.endArrowStyle;
				Schema.linkerDefaults.lineStyle.endArrowStyle = e.endArrowStyle
			}
...
Designer.addFunction("setFillStyle", function(f) {
	...
	e = Designer.events.push("settingFillStyle", e);
	if(e.length == 0) {
		return
	}
	var g = [];
...
Designer.addFunction("setShapeProps", function(h) {

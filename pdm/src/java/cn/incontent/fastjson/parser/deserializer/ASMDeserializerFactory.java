...
import static cn.incontent.fastjson.util.ASMUtils.getDesc;
import static cn.incontent.fastjson.util.ASMUtils.getType;
...
import cn.incontent.fastjson.asm.ClassWriter;
import cn.incontent.fastjson.asm.FieldVisitor;
import cn.incontent.fastjson.asm.Label;
import cn.incontent.fastjson.asm.MethodVisitor;
import cn.incontent.fastjson.asm.Opcodes;
...
import cn.incontent.fastjson.parser.ParseContext;
import cn.incontent.fastjson.parser.ParserConfig;
import cn.incontent.fastjson.parser.SymbolTable;
import cn.incontent.fastjson.parser.DefaultJSONParser.ResolveTask;
import cn.incontent.fastjson.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
import cn.incontent.fastjson.util.ASMClassLoader;
            ...
            if (fieldClass == boolean.class) {
                ...
                if (actualTypeArgument instanceof Class) {
                    ...
                    if (itemClass == String.class) {
                        mw.visitLdcInsn(cn.incontent.fastjson.asm.Type.getType(getDesc(fieldClass))); // cast
...
//         mw.visitMethodInsn(INVOKEVIRTUAL, getType(java.io.PrintStream.class), "println", "(I)V");
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(cn.incontent.fastjson.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getConfig", "()"
                                                                                         + getDesc(ParserConfig.class));
        mw.visitLdcInsn(cn.incontent.fastjson.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));

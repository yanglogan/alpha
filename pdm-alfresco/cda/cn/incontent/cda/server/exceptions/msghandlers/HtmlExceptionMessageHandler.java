 ...
 *Instruction : 
 **/
public class HtmlExceptionMessageHandler implements IExceptionMessageHandler {
	...
	public ErrorMessage getErrorMessage(Throwable e) {
		...
		return new ErrorMessage(msg, ExceptionProcessor.stringToHtml(ExceptionProcessor.getStackTrace(e)));
	}
